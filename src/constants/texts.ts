...
const FormTexts = {
  ...
  tutela: {
    userName: {
      ...
      errorMessage: "Por favor ingresa un nombre de quien diligencia válido.",
      validators: [],
      minLength: 2,
      maxLength: 100,
    } as FieldProps,
    ...
    address: {
      ...
      typeComponent: "input",
      typeField: "text",
      label: "Dirección de quien diligencia",
      required: true,
    ...
    city_state: {
      ...
      typeComponent: "input",
      typeField: "text",
      label: "Ciudad y Departamento de quien diligencia",
      required: true,
      fieldPlaceholder: "Ej. Bogotá, Cundinamarca",
      errorMessage: "Por favor ingresa una ciudad y departamento válidos.",
      validators: [],
      minLength: 5,
      maxLength: 100,
    } as FieldProps,
  ...
  peticion: {
    userName: {
      ...
      typeComponent: "input",
      typeField: "text",
      label: "Nombre de quien presenta la petición",
      required: true,
      fieldPlaceholder: "Ej. Juan Pérez",
      errorMessage:
        "Por favor ingresa el nombre de quien presenta la petición.",
      validators: [],
      minLength: 2,
      maxLength: 100,
    } as FieldProps,
    ...
    idNumber: {
      ...
      typeComponent: "input",
      typeField: "text",
      label: "Número de cédula, tarjeta de identidad o pasaporte",
      required: true,
      fieldPlaceholder: "Ej. 12345678",
      errorMessage: "Por favor ingresa un número de documento válido.",
      validators: [],
    ...
    cityDate: {
      ...
      typeComponent: "input",
      typeField: "text",
      label: "Ciudad y fecha de presentación",
      required: true,
      fieldPlaceholder: "Ej. Bogotá, 27 de agosto de 2025",
      errorMessage: "Por favor ingresa la ciudad y fecha de presentación.",
      validators: [],
      minLength: 10,
      maxLength: 100,
    } as FieldProps,
    ...
    responseAddress: {
      ...
      required: false,
      fieldPlaceholder: "Ej. Calle 123 #45-67, Bogotá",
      errorMessage: "Por favor ingresa una dirección válida.",
      validators: [],
      minLength: 10,
      maxLength: 200,
  ...
  transito: {
    ...
    idNumber: {
      ...
      required: true,
      fieldPlaceholder: "Ej. 12345678",
      errorMessage: "Por favor ingresa un número de cédula válido.",
      validators: [],
      minLength: 6,
      maxLength: 15,
      pattern: /^[0-9]+$/,
